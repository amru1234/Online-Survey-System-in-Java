...
heading.setFont(new Font("Times New Roman", Font.BOLD, 

40)); frame.add(heading);
...
frame.add(uPass2);
JPasswordField uPassField2 = new 
JPasswordField(); uPassField2.setBounds(250, 300, 
150, 30); frame.add(uPassField2);
...
All Details!!!", "Warning Message", JOptionPane.WARNING_MESSAGE);
}
else {
...
Succesfully!!!", "User Created", JOptionPane.PLAIN_MESSAGE); 
frame.dispose();
}
else {
